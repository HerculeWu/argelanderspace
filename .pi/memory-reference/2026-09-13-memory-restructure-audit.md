...
状态：历史审计（2026-09-13 重构收尾时点，以下“未提交”等描述保留为当时事实）。后续用户另授权提交推送，已由 `96d392a` 持久化；不是当前工作区状态或现行问题清单。初次 session 原文：`96d392a20cb4cb6e3139333299efec31ca58579b:.pi/inbox/2026-09-13-mem-31b251a-memory-restructure.md`。制度权威在 [inbox 协议](../inbox/README.md)，最新整理在 [2026-09-16 审计](2026-09-16-inbox-merge-audit.md)。本文只修来源入口，不重新宣称历史验证。
